...
import BusinessImg from "../../../../public/assests/business-img.png";
			...
			<div className="w-full 800px:flex items-center">
				...
				<div className="800px:w-[50%] w-full">
					...
					<p className={styles.label}>
						...
						Eaque unde voluptatum dignissimos, nulla perferendis
						dolorem voluptate nemo possimus magni deleniti natus
						accusamus officiis quasi nihil commodi, praesentium
